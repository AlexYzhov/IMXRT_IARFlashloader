...
#include "QSPI_25Q128JVSQ.h"

/** public data **/
const device_t QSPIFlash_25Q128JVSQ =
{
	.init = init,
	.write = write,
	.erase = erase,
...
#endif /* USE_ARGC_ARGV */
{
	...
	flexspi_device_config_t QSPIFlash_25Q128JVSQ_config = {
    ...
    FLEXSPI_SetFlashConfig(FLEXSPI, &QSPIFlash_25Q128JVSQ_config, kFLEXSPI_PortA1);
	
	/* Update LUT table. */
    FLEXSPI_UpdateLUT(FLEXSPI, 0, QSPIFlash_25Q128JVSQ_LUT, sizeof(QSPIFlash_25Q128JVSQ_LUT)/sizeof(uint32_t));
